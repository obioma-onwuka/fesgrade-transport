<rs-module-wrap id="rev_slider_27_1_wrapper" data-alias="slider-7" data-source="gallery" style="visibility:hidden;background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
    <rs-module id="rev_slider_27_1" style="" data-version="6.5.8">
        <rs-slides>
            <rs-slide style="position: absolute;" data-key="rs-70" data-title="Slide" data-thumb="{{ asset('/front/assets/slider-11.jpg') }}" data-in="o:0;" data-out="a:false;">
                <img src="{{ asset('/front/assets/slider-11.jpg') }}" alt="Image" title="slider-1" width="1614" height="908" class="rev-slidebg tp-rs-img" data-parallax="3" data-panzoom="d:10000;ss:100;se:120%;" data-no-retina>
                <rs-layer
                    ...
                    style="z-index:8;"
                    ><img src="{{ asset('/front/assets/slider-shape11.png') }}" alt="" class="tp-rs-img" width="1903" height="901" data-c="cover-proportional" data-no-retina> 
                </rs-layer>
                ...
                <a id="slider-27-slide-70-layer-6" 
                    class="rs-layer rev-btn"
            ...
            <rs-slide style="position: absolute;" data-key="rs-72" data-title="Slide" data-thumb="{{ asset('/front/assets/slider-1-2.jpg') }}" data-in="o:0;" data-out="a:false;">
                <img src="{{ asset('/front/assets/slider-1-2.jpg') }}" title="slider-1" width="1606" height="815" class="rev-slidebg tp-rs-img" data-parallax="3" data-panzoom="d:10000;ss:100;se:120%;" data-no-retina>
                <rs-layer
                    ...
                    data-frame_999="o:0;st:w;"
                    style="z-index:8;"
                    ><img src="{{ asset('/front/assets/slider-1-2.jpg') }}" alt="" class="tp-rs-img" width="1903" height="901" data-c="cover-proportional" data-no-retina> 
                </rs-layer>
                <rs-layer
